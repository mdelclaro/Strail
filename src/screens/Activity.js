...
class Activity extends Component {
  ...
  locationChanged = () => {
    this.watchID = navigator.geolocation.watchPosition(
      lastPosition => {
        const latitude = parseFloat(JSON.stringify(lastPosition.coords.latitude));
        const longitude = parseFloat(JSON.stringify(lastPosition.coords.longitude));
...
const mapStateToProps = state => {
  return {
    encodedPolyline: state.activity.polyline,
